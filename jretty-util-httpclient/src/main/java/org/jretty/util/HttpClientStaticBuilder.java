 ...
 * @since 2017-1-10
 */
public class HttpClientStaticBuilder {
    /*
    with spring, you can use:
     <bean id="httpClient" class="org.jretty.util.HttpClientStaticBuilder"
    ...
    */
     ...
     * @return
     */
    public static CloseableHttpClient build(final Integer connRequestTimeout, final Integer connSokectTimeout, final Integer soTimeout, 
     ...
     * @return
     */
    public static CloseableHttpClient buildDefault() {
     ...
     */
    public static HttpClientBuilder custom(final Integer connRequestTimeout, final Integer connSokectTimeout, final Integer soTimeout, 
            final Integer maxConnPerRoute, final Integer maxConnTotal) {
        /**
         * max Http Connection live time in Pool 
         * 创建好的conn一般没必要回收，除非在 偶尔有短暂大量的连接出现 的场景。
         * @see org.apache.http.pool.PoolEntry#PoolEntry(String, Object, Object, long, TimeUnit)
         */
        final long connTimeToLive = -1;
        ...
        // Create global socket configuration
        ...
        HttpClientBuilder builder = HttpClientBuilder.create()
            ...
            .setConnectionTimeToLive(connTimeToLive, null)
