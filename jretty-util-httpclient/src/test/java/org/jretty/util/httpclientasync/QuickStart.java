package org.jretty.util.httpclientasync;
...
import org.jretty.util.HttpAsynClientStaticBuilder;
...
public class QuickStart {
    ...
    static void test() throws InterruptedException, ExecutionException, IOException {
        ...
        CloseableHttpAsyncClient httpclient = HttpAsynClientStaticBuilder.buildDefault();
        try {
            // Start the client
            httpclient.start();
